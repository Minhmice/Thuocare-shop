    ...
    <div className="mt-5 grid gap-3">
      <label className="grid gap-1 text-sm font-semibold text-slate-800">
        ...
        <input
          ...
          className="h-11 rounded-2xl border px-4 outline-none focus:ring-2 focus:ring-(--lc-blue-700)/25"
        />
      </label>

      <div className="rounded-2xl bg-(--lc-surface) p-4">
      ...
      <Button
        className="h-11 rounded-full bg-(--lc-blue-700) text-white hover:bg-(--lc-blue-800)"
